...
${OBJECTDIR}/ooc/exception.o: ooc/exception.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ooc/exception.o ooc/exception.c

${OBJECTDIR}/ooc/list.o: ooc/list.c 
	${MKDIR} -p ${OBJECTDIR}/ooc
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ooc/list.o ooc/list.c

${OBJECTDIR}/ooc/ooc.o: ooc/ooc.c 
	${MKDIR} -p ${OBJECTDIR}/ooc
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ooc/ooc.o ooc/ooc.c
