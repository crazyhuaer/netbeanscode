...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/smarthome: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/smarthome ${OBJECTFILES} ${LDLIBSOPTIONS} -pthread
...
${OBJECTDIR}/cii/array.o: cii/array.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cii/array.o cii/array.c

${OBJECTDIR}/cii/atom.o: cii/atom.c 
	${MKDIR} -p ${OBJECTDIR}/cii
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cii/atom.o cii/atom.c

${OBJECTDIR}/cii/except.o: cii/except.c 
	${MKDIR} -p ${OBJECTDIR}/cii
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cii/except.o cii/except.c

${OBJECTDIR}/cii/list.o: cii/list.c 
	${MKDIR} -p ${OBJECTDIR}/cii
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cii/list.o cii/list.c

${OBJECTDIR}/cii/mem.o: cii/mem.c 
	${MKDIR} -p ${OBJECTDIR}/cii
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cii/mem.o cii/mem.c

${OBJECTDIR}/cii/ring.o: cii/ring.c 
	${MKDIR} -p ${OBJECTDIR}/cii
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cii/ring.o cii/ring.c
...
${OBJECTDIR}/lib_network.o: lib_network.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib_network.o lib_network.c

${OBJECTDIR}/lib_system.o: lib_system.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib_system.o lib_system.c
